...
@parametrize("obj,truth", [(Some(1), True), (NONE, False)])
def test_bool(obj, truth):
    assert bool(obj) is truth


@parametrize("obj,raise_", [(Some(1), False), (NONE, True)])
...
@parametrize(
    "obj,raise_", [(Some(1), False), (Some(None), False), (NONE, True)]
)
...
@parametrize(
    "obj,default,exp", [(Some(0), 1, 0), (Some(False), 1, False), (NONE, 0, 0)]
)
...
@parametrize(
    "obj1,obj2,eq",
    [(Some(1), Some(1), True), (NONE, NONE, True), (Some(1), None, False)],
)
